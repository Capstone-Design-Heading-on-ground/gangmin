            ...
            <div id="main">
                ...
                <div id="info">            
                    ...
                    <dl>
            			...
            			<dd><img src="${contextPath}/images/star.png" style="width:20px; height:20px;"> <fmt:formatNumber value="${infoLecture.lsumgrade / infoLecture.lcountgrade}" pattern=".00"/></dd>
                    </dl>
