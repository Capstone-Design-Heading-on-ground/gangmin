...
public class LectureVO {
	...
	public LectureVO(int lkey, String lid, String lname, String ltype, String lconst,String lsubject, String lunit
			,String luser, String lcreate, String llevel, int ltime, int lprice, int lduration, String linfo,
			String ltarget, String limage, Date lstartdate, int lsumgrade, int lcountgrade ,String lacademy) 
	{
		this.lkey = lkey;
		this.lid = lid;
		this.lname = lname;
	...
	public String getLconst() {
		return lconst;
	}

	public void setLconst(String lconst) {
		this.lconst = lconst;
	}
	...
	public String getLacademy() {
		return lacademy;
	}
	
	public void setLacademy(String lacademy) {
		this.lacademy = lacademy;
	}
